...
export var Upload = function (props) {
    ...
    return (React.createElement("div", { className: "xdf-upload-component" },
        React.createElement("div", { className: "xdf-upload-input", style: { display: "inline-block" }, onClick: handleClick },
            drag ? (React.createElement(Dragger, { onFile: function (files) {
                    uploadFiles(files);
                } }, children)) : (children),
            React.createElement("input", { type: "file", className: "xdf-file-input", style: { display: "none" }, onChange: handleFileChange, ref: fileInput, multiple: multiple, accept: accept })),
