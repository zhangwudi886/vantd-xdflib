...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "xdf-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "xdf-upload-list-item", key: item.uid },
