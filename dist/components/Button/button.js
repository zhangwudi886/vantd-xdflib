...
export var Button = function (props) {
    var _a;
    var disabled = props.disabled, size = props.size, btnType = props.btnType, children = props.children, className = props.className, href = props.href, restProps = __rest(props, ["disabled", "size", "btnType", "children", "className", "href"]);
